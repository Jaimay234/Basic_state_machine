...
This was a project that needed to be done for a VHDL progrmaming class. It is a very simple state machine that will cycle through a couple of states and then it will store the value and stop after a while. There is a basic implementation of a state machine and two variable implementations one with and without states
## Overview
